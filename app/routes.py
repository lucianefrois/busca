...
from app.forms import FormFuncionario, FormCliente, FormProduto, FormGalpao, FormTarefa, FormEstoque, FormFuncionarioTarefa, FormHistoricoCompra, FormRegistroInteracao
from app.models import Funcionario, Cliente, Produto, Galpao, Tarefa, Estoque, Funcionario_tarefa, Historico_compra, Registro_interacao
